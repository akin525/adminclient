...
export default function Searchpurchase({color}) {
    ...
    const baseURL2 = "https://admin.server.savebills.com.ng/api/auth/searchpurchase";
        ...
        axios
            ...
            .then(response => {
                ...
                if (response.data.bill == null){
                    ...
                    setError("");
                    setname(response.data.bill.username);
                    setnumber(response.data.bill.phone);
                    setserver(response.data.bill.server_res);
                    setnetwork(response.data.bill.plan);
                    setstatus(response.data.bill.result);
                    setrefid(response.data.bill.refid);
                    setamount(response.data.bill.amount);
                    setdate(response.data.bill.createdAt);
                    setupdate(response.data.bill.updatedAt);
                    setid(response.data.bill.id);
                    setshow(1);
